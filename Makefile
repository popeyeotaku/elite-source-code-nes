...
all:
	...
	@$(PYTHON) cat.py 3-assembled-output/header.bin 3-assembled-output/bank0.bin 3-assembled-output/bank1.bin 3-assembled-output/bank2.bin 3-assembled-output/bank3.bin 3-assembled-output/bank4.bin 3-assembled-output/bank5.bin 3-assembled-output/bank6.bin 3-assembled-output/bank7.bin > 3-assembled-output/elite.bin
	@$(PYTHON) cp.py 3-assembled-output/elite.bin 5-compiled-rom-images/ELITE$(suffix).NES
ifneq ($(verify), no)
